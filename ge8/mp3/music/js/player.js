...
function play(music) {
    ...
    if(music.source == "netease") {
        ...
        music.url = music.url.replace(/http:\/\/zhangmenshiting.qianqian.com/g, "http://gss0.bdstatic.com/y0s1hSulBw92lNKgpU_Z2jR7b2w6buu");
    }
